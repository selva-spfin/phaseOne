      ...
      <section>
        ...
        <section className="px-10 py-8 sm:py-10 md:px-20 lg:py-14  ">
          <div className="container mx-auto rounded-xl border border-black bg-purple-800 p-10  text-white sm:p-16 ">
            <h2 className="pb-5 text-2xl sm:text-3xl">
          ...
          <div className="container mx-auto ">
            ...
            <div className="py-3 sm:py-5">
              ...
              <p className="py-3 text-neutral-800">
                ...
                collateral or security. This makes it a flexible financing
                option, as there are no limitations on its use.
              </p>
              <ul
                role="list"
              ...
              >
                ...
                <li className=" py-3 sm:indent-10">
                  ...
                  <span className="ml-2 sm:ml-1">
                    ...
                    surgery or hospitalization, a personal loan can help cover
                    the costs.
                  </span>
                </li>
                <li className="py-3 sm:indent-10">
            ...
            <div className="py-5 ">
              ...
              <p className="text-xl">
                To qualify for a personal loan, you have to meet certain
                criteria. Below are the important factors that lenders take into
            ...
            <div className="py-5 ">
              ...
              <ul className="list-inside list-disc">
                ...
                <li className="py-3 indent-10 md:text-lg">
                  <b> Proof of Residence or Address Proof</b> - Passport,
                  Voter’s ID, Driving License, PAN Card, Aadhaar Card,
                ...
                <li className="py-3 indent-10 md:text-lg">
                  <b>Business proof</b> - Business registration documents such
                  as a partnership deed, Memorandum of Association (MOA),
            ...
            <div className="py-5">
              ...
              <p className="py-3 indent-10  md:text-lg">
                An EMI calculator is a useful tool that can help you estimate
                the monthly installments you will have to pay towards your
                personal loan within a specific period. By using the Ruloans EMI
                calculator, you can calculate your EMI beforehand, which can
                help you plan your finances better. Additionally, you can check
                your eligibility and compare different loan options using
                Ruloans Personal Loan calculator.
              </p>
            </div>
          </div>
        </section>
